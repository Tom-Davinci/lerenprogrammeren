...
if change > 0: # Zorgt ervoor, dat er alleen wat gebeurt als er daadwerkelijk geld gewisseld moet worden.
  coinValue = 50 # zorgt voor de initele grootte van kleingeld terug gegeven, dus 50 cent
...
coinarr = [50,20,10,5,3,2,1]
returnarr = [nr50Returned, nr20Returned, nr10Returned, nr5Returned, nr3Returned, nr2Returned, nr1Returned]
index = 0
while index < 7:
